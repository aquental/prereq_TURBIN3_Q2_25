...
#[cfg(test)]
mod tests {
    //generate a new keypair with the keygen function.
    //importKeypair, Signer & Pubkey from solana_sdk
    ...
    //import RpcClient to establish a connection to the Solana devnet
    //read_keypair_file lets import wallet from a wallet file.
